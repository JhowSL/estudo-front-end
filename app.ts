...
console.log('------------------');
console.log('array com elemento adicionado: ', myArray);
console.log('------------------');
...
console.log('------------------');
console.log('array com elemento adicionado: ', numberArray);
console.log('------------------');
...
console.log('------------------');
console.log('array com elemento adicionado: ', booleanArray);
console.log('------------------');
...
console.log('------------------');
console.log('array com elemento adicionado: ', objectArray);
console.log('------------------');
